    ...
    return(
        ...
        <header className={styles.header}>
            <nav className='w3-top w3-bar w3-black'>
                ...
                <div className={router.pathname=='/contact' ? 'w3-text-white  w3-bar-item' :'w3-text-grey  w3-bar-item'} style={{marginRight:15,fontSize:20}}><Link href="/contact">contact</Link></div>
